...
- **A–D**
  - **A** = ad hoc or unknown
  - **B** = partial or informal
  - **C** = documented and owned
  - **D** = tested in the last 12 months with logs and follow-up actions
- **Evidence levels**
  - **E0** no evidence
  - **E1** verbal only
  - **E2** documented artifact with an owner role
  - **E3** tested in the last 12 months with logs and follow-up actions (CAPA)
